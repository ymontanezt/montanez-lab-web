...
export const galleryImages: GalleryImage[] = [
  {
    ...
    title: 'Prótesis Fija en Zirconio',
    description:
      'Coronas y puentes fabricados en zirconio de grado médico. Material biocompatible que ofrece máxima estética y durabilidad.',
    src: '/modern-dental-lab.png',
    alt: 'Prótesis fija en zirconio con acabado premium',
    category: 'prosthetics',
    tags: ['Zirconio', 'Prótesis Fija', 'Estética', 'Durabilidad', 'Biocompatible'],
    width: 1200,
    height: 800,
    isActive: true,
    order: 1,
  },
  {
    ...
    updatedAt: new Date('2024-12-01'),
    title: 'Prótesis Fija en Disilicato',
    description:
      'Coronas y carillas en disilicato de litio. Material cerámico que combina máxima estética con excelente resistencia.',
    src: '/dental-team-laboratory.png',
    alt: 'Prótesis fija en disilicato con transparencia natural',
    category: 'prosthetics',
    tags: ['Disilicato', 'Prótesis Fija', 'Estética', 'Transparencia', 'Resistencia'],
    width: 1200,
    height: 800,
    isActive: true,
    order: 2,
  },
  {
    ...
    description:
      'Coronas y puentes con estructura metálica recubierta de porcelana. Solución tradicional con excelente durabilidad.',
    src: '/dental-technician-portrait.png',
    alt: 'Prótesis fija metal-porcelana con acabado profesional',
    category: 'prosthetics',
    tags: ['Metal-Porcelana', 'Prótesis Fija', 'Durabilidad', 'Tradicional', 'Resistencia'],
    width: 800,
    height: 1200,
    isActive: true,
    order: 3,
  },
  {
    ...
    updatedAt: new Date('2024-12-01'),
    title: 'Prótesis Ivocrom',
    description:
      'Prótesis removibles de alta calidad fabricadas con tecnología Ivocrom. Material premium para máxima comodidad y estética.',
    src: '/female-orthodontist-portrait.png',
    alt: 'Prótesis removibles Ivocrom con acabado premium',
    category: 'prosthetics',
    tags: ['Ivocrom', 'Prótesis Removibles', 'Calidad', 'Comodidad', 'Estética'],
    width: 800,
    height: 1200,
    isActive: true,
    order: 4,
  },
  {
    ...
    description:
      'Prótesis dentales completas fabricadas con materiales premium. Diseño personalizado para máxima funcionalidad y confort.',
    src: '/male-implant-specialist.png',
    alt: 'Prótesis totales con diseño personalizado y materiales premium',
    category: 'prosthetics',
    tags: [
      'Prótesis Totales',
      'Completas',
  ...
  },
  {
    ...
    description:
      'Prótesis removibles flexibles fabricadas con materiales de alta resistencia. Máxima comodidad y adaptabilidad para el paciente.',
    src: '/dental-scanner-workflow.png',
    alt: 'Prótesis flexibles con materiales de alta resistencia',
    category: 'prosthetics',
    tags: ['Prótesis Flexibles', 'Removibles', 'Alta Resistencia', 'Comodidad', 'Adaptabilidad'],
    width: 1200,
    height: 800,
    isActive: true,
    order: 6,
  },
  {
    ...
    description:
      'Prótesis parciales removibles con estructura metálica de precisión. Diseño funcional que preserva la salud de los dientes remanentes.',
    src: '/modern-dental-lab.png',
    alt: 'Prótesis parciales removibles con estructura metálica de precisión',
    category: 'prosthetics',
    tags: ['PPR', 'Prótesis Parciales', 'Removibles', 'Estructura Metálica', 'Precisión'],
    width: 1200,
    height: 800,
    isActive: true,
    order: 7,
  },
  {
    ...
    updatedAt: new Date('2024-12-01'),
    title: 'Laboratorio de Vanguardia',
    description:
      'Instalaciones modernas con tecnología CAD/CAM de última generación. Equipos de precisión para fabricación de prótesis dentales.',
    src: '/professional-female-dentist.png',
    alt: 'Laboratorio dental moderno con equipos de última generación',
    category: 'laboratory',
    tags: ['Laboratorio', 'Vanguardia', 'CAD/CAM', 'Tecnología', 'Precisión'],
    width: 800,
    height: 1200,
    isActive: true,
    order: 8,
