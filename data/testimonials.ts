...
export const testimonials: Testimonial[] = [
  {
    ...
    text: 'La precisión de las prótesis digitales de Montañez Lab ha revolucionado mi práctica. Mis pacientes están encantados con los resultados y la calidad excepcional de cada trabajo.',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'Los implantes de Montañez Lab ofrecen la mejor predictibilidad quirúrgica que he experimentado en 20 años de práctica. La planificación 3D es increíblemente precisa.',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'Los alineadores de Montañez Lab son los más cómodos y efectivos que he usado. Mis pacientes adolescentes los prefieren y los resultados son excepcionales.',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'Las carillas de Montañez Lab han transformado completamente la confianza de mis pacientes. La calidad estética es excepcional y los resultados naturales.',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'Mi hija ahora ama ir al dentista gracias al equipo de Montañez Lab. Su enfoque con niños es excepcional y los tratamientos son completamente indoloros.',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'A las 2 AM con un dolor insoportable, Montañez Lab me atendió inmediatamente. Su servicio de urgencias es invaluable y el personal es sumamente profesional.',
    name: 'Jorge Martínez',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'La tecnología CAD/CAM de Montañez Lab ha mejorado significativamente la precisión de mis trabajos. Los tiempos de entrega son excelentes y la calidad es consistente.',
    name: 'Dr. Luis Pérez',
  ...
  },
  {
    ...
    createdAt: new Date('2024-01-01'),
    updatedAt: new Date('2024-12-01'),
    text: 'He trabajado con varios laboratorios, pero Montañez Lab es el único que cumple con todos mis estándares de calidad. Sus prótesis son perfectas desde la primera vez.',
