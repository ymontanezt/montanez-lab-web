    ...
    >
      ...
      <div className="container mx-auto px-4">
              ...
              <div className="team-carousel scrollbar-hide flex gap-4 overflow-x-auto px-4 pb-4">
                {displayMembers.map((member, index) => (
                  <motion.div
                    ...
                    style={{ width: '280px' }}
                  >
                    <div className="relative overflow-hidden rounded-2xl border border-teal-200 bg-white shadow-xl transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl dark:border-teal-400/20 dark:bg-gray-800 dark:shadow-2xl dark:hover:bg-gray-700">
                      {/* Imagen del miembro */}
                      <div className="relative aspect-[4/5] overflow-hidden">
                        {member.image ? (
                          ...
                          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-teal-100 to-indigo-100 dark:from-teal-900/30 dark:to-indigo-900/30">
                        ...
                        <div className="absolute top-4 right-4">
                          <span className="inline-flex items-center gap-1 rounded-full border border-amber-500/30 bg-amber-600/90 px-3 py-1 text-xs font-semibold text-white shadow-lg backdrop-blur-sm">
                      ...
                      <div className="p-6">
                        ...
                        <div className="mb-4 text-center">
                          ...
                          <p className="mb-1 text-lg font-semibold text-teal-600 dark:text-teal-400">
                          ...
                          <div className="text-center">
                            ...
                            <div className="flex flex-wrap justify-center gap-2">
                              {member.certifications.slice(0, 2).map((cert, idx) => (
                                <span
                                  key={idx}
                                  className="rounded-full border border-teal-200 bg-teal-50 px-3 py-1 text-xs font-medium text-teal-700 dark:border-teal-700/50 dark:bg-teal-900/30 dark:text-teal-300"
                                >
                                  {cert}
                                </span>
                              ))}
        ...
        {isSmallTeam && (
          ...
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-teal-200 bg-teal-50 px-6 py-3 dark:border-teal-400/30 dark:bg-teal-900/30">
