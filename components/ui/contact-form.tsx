  ...
  if (isSubmitted) {
    return (
      <motion.div
        ...
        className="rounded-xl border border-teal-200 bg-teal-50 p-8 text-center dark:border-teal-700/50 dark:bg-teal-900/20"
      >
        <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-teal-200 bg-teal-100 dark:border-teal-600 dark:bg-teal-800/50">
          <CheckCircle className="h-8 w-8 text-teal-600 dark:text-teal-400" />
        </div>
        <h3 className="mb-2 text-xl font-semibold text-teal-800 dark:text-teal-200">
          ¡Mensaje enviado exitosamente!
        </h3>
        <p className="text-teal-600 dark:text-teal-300">
          Hemos recibido tu consulta. Nos pondremos en contacto contigo en las próximas 24 horas.
        </p>
        <p className="mt-2 text-sm text-teal-500 dark:text-teal-400">Gracias por contactarnos</p>
      </motion.div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} className={cn(variants[variant], className)}>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div>
          ...
          <Input
            ...
            className={cn(
              'border-teal-200 focus:border-teal-500 focus:ring-teal-500/20 dark:border-gray-600',
      ...
      <Button
        ...
        className="w-full rounded-lg bg-teal-600 px-6 py-3 font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-teal-700 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100 dark:bg-teal-700 dark:hover:bg-teal-600"
      >
        {isSubmitting ? (
